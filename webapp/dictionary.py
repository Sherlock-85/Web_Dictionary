...
class Dictionary(page.Page):
    ...
    def serve(cls, req):
        ...
        jp.Div(a=div, text="Get the definition of an English word instantly as you type.", classes="text-lg")

        input_div = jp.Div(a=div, classes="grid grid-cols-2")

        output_div = jp.Div(a=div, classes="m-2 text-lg border-2 h-40")
